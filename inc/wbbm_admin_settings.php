...
class MAGE_WBBM_Setting_Controls {
    ...
    function admin_menu() {
        //add_options_page( 'Event Settings', 'Event Settings', 'delete_posts', 'mep_event_settings_page', array($this, 'plugin_page') );
         ...
         // add_submenu_page('edit.php?post_type=wbbm_bus', 'bookings', 'Bookings', 'manage_options', 'bookings', 'bookings');
    }
    ...
    function get_settings_fields() {
        $settings_fields = array(
            'wbbm_general_setting_sec' => array(
                ...
                array(
                    'name' => 'wbbm_cpt_booking_cutofftime',
                    'label' => __( 'Booking Cut Off Time', 'bus-booking-manager' ),
                    'desc' => __( 'Pease enter time in minutes. Default time is 90 mins.', 'bus-booking-manager' ),
                    'type' => 'text',
                    'default' => '90'
        ...
        array(
         ...
         'wbbm_style_setting_sec' => array(
                ...
                array(
                    ...
                    'label' => __( 'Chose Search Form Background Color', 'bus-booking-manager' ),
                    'desc' => __( 'Chose Search Form Background Color', 'bus-booking-manager' ),
                    'type' => 'color',
                ),
                array(
                    'name' => 'wbbm_search_form_dropdown_b_color',
                    'label' => __( 'Chose Search Form Dropdown Background Color', 'bus-booking-manager' ),
                    'desc' => __( 'Chose Search Form Dropdown Background Color', 'bus-booking-manager' ),
                    'type' => 'color',
                ),
                array(
                    'name' => 'wbbm_search_form_dropdown_t_color',
                    'label' => __( 'Chose Search Form Dropdown Text Color', 'bus-booking-manager' ),
                    'desc' => __( 'Chose Search Form Dropdown Text Color', 'bus-booking-manager' ),
                    'type' => 'color',
                ),
                array(
                    'name' => 'wbbm_search_form_result_b_color',
                    'label' => __( 'Chose Search Form Result Background Color', 'bus-booking-manager' ),
                    'desc' => __( 'Chose Search Form Result Background Color', 'bus-booking-manager' ),
                    'type' => 'color',
                ),
                array(
                    'name' => 'wbbm_search_route_title_b_color',
                    'label' => __( 'Chose Search Route Title Background color', 'bus-booking-manager' ),
                    'desc' => __( 'Chose Search Route Title Background color', 'bus-booking-manager' ),
                    'type' => 'color',
                )
            ),
        );
